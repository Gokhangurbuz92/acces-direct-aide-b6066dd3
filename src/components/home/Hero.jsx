...
export function Hero() {
  return (
    <section className="relative bg-background bg-blueprint-grid bg-[size:40px_40px] py-20 md:py-32">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          {/* Heading */}
          <h1 className="font-heading font-extrabold text-4xl md:text-5xl lg:text-6xl text-ink leading-tight">
